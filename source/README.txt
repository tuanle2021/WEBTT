...
Tạo database TACA(Xem trong file ./source/user-guest/code/config/key.config.js để biết thêm chi tiết)
Tạo các collection có tên trùng với tên các file .json trong thư mục ./source/database
